import pymysql
from pylab import *
from machine_learning.Tushare_Sample import Cap_Update_daily as cap_update, Filter, Model_Evaluate as ev, \
    Portfolio as pf
import tushare as ts

def get_sharp_rate():
    db = pymysql.connect(host='127.0.0.1', user='root', passwd='123456', db='stock_test', charset='utf8')
    cursor = db.cursor()
